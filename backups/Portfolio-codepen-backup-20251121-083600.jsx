// Backup of original Portfolio.jsx prior to adding CodepenExperiments section
...
const Portfolio = () => {
  ...
  const openProjectModal = (project) => { setSelectedProject(project); setModalOpen(true); };
  const closeProjectModal = () => { setModalOpen(false); setSelectedProject(null); };
  const openDesignModal = (design) => { setSelectedDesign(design); setDesignModalOpen(true); };
  const closeDesignModal = () => { setDesignModalOpen(false); setSelectedDesign(null); };
  ...
  return (
    <main className="portfolio-page container" id="main-content" aria-labelledby="page-title">
      ...
      <Modal isOpen={designModalOpen} onClose={closeDesignModal} size="xl" className="design-modal-overlay">
        {selectedDesign && (
            ...
            <div className="design-modal-info">
              ...
              {selectedDesign.breakdown && (
                <div className="ux-breakdown">
                  <h3>UX Breakdown</h3>
                  <div className="breakdown-content">{selectedDesign.breakdown}</div>
                </div>
              )}
            </div>
          </div>
